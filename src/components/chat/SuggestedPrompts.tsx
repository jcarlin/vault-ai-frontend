...
function SparkleIcon() {
  return (
    <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center mx-auto mb-6">
      <svg viewBox="0 0 24 24" fill="none" className="h-8 w-8 text-emerald-500">
        <path
  ...
  return (
    <button
      ...
      className={cn(
        ...
        'hover:bg-zinc-800/50 hover:border-zinc-700/50 transition-all',
        'text-left disabled:opacity-50 disabled:cursor-not-allowed'
      )}
    >
      <div className="h-10 w-10 rounded-lg bg-zinc-800/80 flex items-center justify-center flex-shrink-0">
        {icon}
      </div>
